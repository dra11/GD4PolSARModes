...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp1(:),2) prctile(90*alp1(:),98)])%%Sea Ice
colormap(cmap)
colorbar
title('QP')
...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp2(:),2) prctile(90*alp2(:),98)])
colormap(cmap)
colorbar
title('DPH')
...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp3(:),2) prctile(90*alp3(:),98)])
colormap(cmap)
colorbar
title('TP')
...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp4(:),2) prctile(90*alp4(:),98)])
colormap(cmap)
colorbar
title('+\pi/4')
...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp5(:),2) prctile(90*alp5(:),98)])
colormap(cmap)
colorbar
title('DCPR')
...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp6(:),2) prctile(90*alp6(:),98)])
colormap(cmap)
colorbar
title('CTLRR')
...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp7(:),2) prctile(90*alp7(:),98)])
colormap(cmap)
colorbar
title('DPV')
...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp8(:),2) prctile(90*alp8(:),98)])
colormap(cmap)
colorbar
title('-\pi/4')
...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp9(:),2) prctile(90*alp9(:),98)])
colormap(cmap)
colorbar
title('DCPL')
...
daspect([1 1 1])
caxis([0 90])
%caxis([prctile(90*alp10(:),2) prctile(90*alp10(:),98)])
colormap(cmap)
colorbar
title('CTLRL')
